...
const linkedTabs = [
  { key: 'spells', label: 'Spells', tab: 'spells' },
  { key: 'inventory', label: 'Inventory', tab: 'inventory' },
  { key: 'features', label: 'Features & Traits', tab: 'features' },
  { key: 'notes', label: 'Notes', tab: 'notes' }
]
...
<template>
  <section class="eldra-codex-soft rounded-none p-0">
    ...
    <div class="p-4">
      ...
      <div class="mt-4 overflow-hidden border border-[rgba(201,164,90,0.18)] bg-[rgba(8,17,27,0.44)]">
