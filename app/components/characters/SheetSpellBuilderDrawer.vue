...
<template>
  ...
  >
    ...
    >
      <aside class="eldra-ornate-panel fixed bottom-0 right-0 top-0 flex h-full w-full flex-col border-l backdrop-blur-xl md:pointer-events-auto md:w-[456px] xl:w-[468px]">
