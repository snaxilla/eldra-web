...
<template>
  ...
  >
    ...
    >
      <aside data-sheet-detail-rail class="eldra-ornate-panel fixed bottom-0 right-0 top-0 flex h-full flex-col border-l backdrop-blur-xl md:pointer-events-auto w-full max-w-[440px]">
