...
<template>
  <aside class="eldra-sidebar-ornate eldra-frame-corners flex h-full min-h-0 flex-col border-r border-[rgba(201,164,90,0.24)] bg-[linear-gradient(to_bottom,#090806,#11100d_48%,#070604)] text-[#efe2bd]">
    <!-- COLLAPSED -->
