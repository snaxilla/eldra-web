  ...
  "spell": [
    {
      ...
      "entriesHigherLevel": [
        "When you cast this spell using a spell slot of 2nd level or higher, the spell creates one more dart."
      ]
    }
  ]
}`
...
async function runPreview() {
  ...
  try {
    preview.value = await $fetch('/api/import/preview/5etools/spells', {
      method: 'POST',
      body: {
    ...
    <div class="mx-auto max-w-7xl">
      <div class="mb-8">
        ...
        <h1 class="mt-2 text-3xl font-bold">
          5etools Spell Import Preview
        </h1>
        <p class="mt-3 max-w-3xl text-sm text-neutral-400">
          Paste 5etools spell JSON and preview how Eldra maps it into import_source and spell_core blocks.
        </p>
      </div>
